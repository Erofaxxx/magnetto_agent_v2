...
name: segmentation
description: |
  сегмент аудитории, именованный сегмент, для сегмента, покажи сегмент, лояльные покупатели, тёплые лиды, аудитория из сегмента, использовать сегмент, ретаргет сегмент, атрибуция для сегмента, segment, audience, кто из сегмента, анализ по сегменту
---
