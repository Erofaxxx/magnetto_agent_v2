...
(ровно топ-5 строк на кампанию в md; sort by cost DESC. Если в кампании 1–4 исключений — выводи столько, сколько есть. Полный размеченный список — в parquet, см. Раздел 10. После таблицы добавь строку: «Полный список — N площадок на исключение, открой parquet выше».)
