...
**Сводка обязательно содержит ВСЕ кампании, активные за период**, не только те где есть исключения. Кампании без исключений (0 кандидатов) — выводи отдельной строкой с прочерками в столбцах «К исключению / Освободим / Останется работать», но **расход и лиды кампании покажи** — иначе сумма ИТОГО не сойдётся с шапкой кабинета. Источник списка кампаний:
