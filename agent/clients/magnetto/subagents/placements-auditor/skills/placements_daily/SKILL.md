...
- Секцию «Parquet-выходы» (словарь колонок parquet с типами и описаниями) — **не выводить**. UI сам рендерит parquet таблицей; дублировать схему в md = лишние токены.
...
**Не выводи в `summary` словарь колонок parquet** («Parquet-выходы» с типами/описаниями). UI рендерит parquet таблицей сам, схема в md — лишние токены. Контракт колонок стабильный, описан в подразделе 10.1.
...
**Колонки** (10 базовых + 11 целевых справа = 21):
...
**Справа добавь 11 целевых колонок с ID Метрики в названии** (для downstream-пайплайнов и ручного дебага в UI; в md-ответ они не идут — md по-прежнему 7 колонок):

| Колонка parquet | Источник |
|---|---|
| `Все лиды (314553735)` | `leads` |
| `Звонки уник. целевые (201619843)` | `call_unique_target` |
| `Звонки уник. (201619840)` | `call_unique` |
| `Звонки целевые (201619846)` | `call_target` |
| `Звонки общие (63191746)` | `call_` |
| `Клики тел. мКЦ (176145847)` | `phone_mcc` |
| `Клики тел. Magnetto (314248561)` | `phone_mag` |
| `Авто-формы (322914144)` | `auto_form` |
| `CRM создан (332069613)` | `crm_created` |
| `CRM оплачен (332069614)` | `crm_paid` |
| `Мусор % (402733217)` | `100. * trash / nullIf(clicks,0)` |

В EXCL-строках большинство этих 11 колонок по определению нули — это нормально, downstream-пайплайны ожидают полный набор полей. В **md-таблицу** их по-прежнему НЕ выводи, ненулевые суррогаты — словами в комментарии «Что не так».
...
# 11 целевых колонок справа (с ID Метрики в имени) — для downstream/UI-дебага.
excl['Все лиды (314553735)'] = excl['leads']
excl['Звонки уник. целевые (201619843)'] = excl['call_unique_target']
excl['Звонки уник. (201619840)'] = excl['call_unique']
excl['Звонки целевые (201619846)'] = excl['call_target']
excl['Звонки общие (63191746)'] = excl['call_']
excl['Клики тел. мКЦ (176145847)'] = excl['phone_mcc']
excl['Клики тел. Magnetto (314248561)'] = excl['phone_mag']
excl['Авто-формы (322914144)'] = excl['auto_form']
excl['CRM создан (332069613)'] = excl['crm_created']
excl['CRM оплачен (332069614)'] = excl['crm_paid']
excl['Мусор % (402733217)'] = excl['Мусор %']
...
excl = excl.rename(columns={
    ...
    'Все лиды (314553735)', 'Звонки уник. целевые (201619843)',
    'Звонки уник. (201619840)', 'Звонки целевые (201619846)',
    'Звонки общие (63191746)', 'Клики тел. мКЦ (176145847)',
    'Клики тел. Magnetto (314248561)', 'Авто-формы (322914144)',
    'CRM создан (332069613)', 'CRM оплачен (332069614)',
    'Мусор % (402733217)']]
