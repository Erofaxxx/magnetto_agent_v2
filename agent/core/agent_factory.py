...
# Inherit MAX_TOKENS from config so deepagents and legacy SegmentBuilderAgent
# truncate output identically; they previously diverged (16384 vs 8192).
from config import MAX_TOKENS as _MAX_TOKENS  # noqa: E402
